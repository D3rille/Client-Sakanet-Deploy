      ...
      return (
        <div key={data.id} className={styles.list}>
          ...
          <div className={styles.details}>
            <h2>{data.name}</h2>
            <p className={styles.title}>{data.location}</p>
          </div>
          </div>
        ...
        <div key='element2' className={styles.content}>
            ...
            <Card sx={{width:'100%',height:'max-Content',borderRadius:'20px',padding:'15px 0px 10px 20px'}}>
                ...
                <div className={styles.myconnectionstitle}>
                  <div className={styles.myconnectionstitle}>
                    <Image sx={{width:'30px',height:'35px',marginTop:'-10px'}} src ={connectionsIcon} alt = "Connections" width={30} height={35}/>
                ...
                <div className={styles.myconnectionstitle}>
                <div className={styles.myconnectionstitle}>
                    <Image sx={{width:'25px',height:'30px',marginTop:'-10px'}} src ={groupicon} alt = "Group" width={25} height={35}/> 
