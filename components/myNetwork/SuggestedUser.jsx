...
function SuggestedUsers({ requestConnection }) {
  ...
  return (
    <>
      {data &&
        data?.getSuggestedUsers?.map((user) => (
          <div key={user._id} className={styles.cardprofile}>
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url("https://greenamerica.org/sites/default/files/pieces/istockag2.jpg")`,
                }}
              >
                <div
              ...
              <div style={{ margin: "5px", textAlign: "center" }}>
                ...
                >
                  {formatShortAddress(user.address)}
                </p>
              </div>
              <div style={{ display: "flex" }}>
                <button
                  ...
                  onClick={() => {
                    requestConnection({ variables: { connectTo: user._id } });
                  }}
                >
                  Connect
                </button>
