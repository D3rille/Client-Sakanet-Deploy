...
import notif from "../public/icons/notification-bell.svg";
import drop from "../public/icons/DropdownIcon.svg";
import CartIcon from "../public/icons/cart-large.svg";
...
import {
  ...
  DELETE_NOTIFICATION,
  CLEAR_NOTIFICATIONS,
} from "../graphql/operations/notification";
...
const Navbar = () => {
  ...
  const [getSuggestions, { loading: searchLoading, data: searchData }] =
  ...
  return (
    <>
      ...
      >
        ...
        <Divider />
        <List>
          {["Products", "My Network", "Messages", "Cart", "Notifications"].map(
            (text, index) => (
